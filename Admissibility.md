...
This document defines the **minimum conditions**
under which an artifact may enter the Matrix repository.

Admissibility is not endorsement.
It is a gate against noise, opinion, and implicit authority.
...
If understanding the artifact requires
specialized background knowledge,
it is not admissible.

Domain-specific examples may be used,
but they must be removable
without collapsing the diagnosis.
...
It must be clear what would have to change
for the transfer to *not* occur.
...
No artifact gains authority by inclusion.
No artifact gains authority by persistence.
