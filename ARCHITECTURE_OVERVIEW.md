...
It regulates the admissibility, level-transitions, and structural legitimacy
of claims, distinctions, and judgments.
...
2.runs/YYYY-MM-DD/run_XX_stresstest_<name>_claim/
...
A STOP does not indicate failure.
It prevents epistemic illegitimacy.
...
They are explicitly acknowledged as structurally necessary,
but not foundationally ultimate.
...
A freeze indicates architectural sufficiency,
not epistemic completeness.

Completeness would imply closure.
Closure would imply authority.
Authority would violate the system’s own constraints.
