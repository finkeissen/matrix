...
## Note
This output is a hint, not a gate. `04a_generation` proceeds with the normalized categories as-is. Gap detection results are passed as context to `04b_generation_review` so the review step can fill identified gaps.
