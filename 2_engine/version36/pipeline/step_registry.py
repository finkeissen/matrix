...
STEP_SPECS: tuple[StepSpec, ...] = (
    StepSpec("00_atomic_problem_curation", "pipeline.steps.00_atomic_problem_curation", "subdomains_file+domain", "candidate_batches"),
    StepSpec("01_atomic_problem_merge",    "pipeline.steps.01_atomic_problem_merge",    "candidate_batches",      "ap_store"),
