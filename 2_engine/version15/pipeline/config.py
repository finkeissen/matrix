"""
config.py v14 — Portable configuration via environment variables or .env file.
...
# ── Prompt variant (for A/B tests) ────────────────────────────────────────────
# Empty string = use active version (*.md)
# "v2"         = use *.v2.md if it exists, else fall back to *.md
PROMPT_VARIANT = _get("PROMPT_VARIANT", "")
