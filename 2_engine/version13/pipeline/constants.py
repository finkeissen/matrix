...
# draft    → generated, not yet pipeline-validated
# reviewed → passed 05_validation (schema + dedup + atomicity checks)
# approved → human or external quality gate confirmed
class ReviewStatus:
    DRAFT    = "draft"
    REVIEWED = "reviewed"
    APPROVED = "approved"
