"""
validator.py — Central validation module for pipeline artifacts.
...
try:
    ...
    print("[warn] jsonschema not installed — schema validation disabled. "
...
def validate_schema(obj: Any, schema_name: str) -> list[dict]:
    ...
    Falls back to empty list (no errors) if jsonschema not installed or schema missing.
    """
    ...
    if schema is None:
        return []  # No schema file — skip silently
