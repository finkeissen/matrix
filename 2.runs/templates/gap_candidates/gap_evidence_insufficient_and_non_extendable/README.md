# Gap Candidate Run Template: Evidence insufficient and non-extendable

This is a **run template** (not an executed run).

Purpose:
- Attempt to construct an admissible path for: **Evidence insufficient and non-extendable**
- If no admissible path exists, terminate with **STOP + GAP**.

This template must be instantiated into a dated run directory under:
`2.runs/YYYY-MM-DD/run_XX_gap_evidence_insufficient_and_non_extendable/`
