# Gap Candidate Run Template: Uncertainty cannot be represented admissibly

This is a **run template** (not an executed run).

Purpose:
- Attempt to construct an admissible path for: **Uncertainty cannot be represented admissibly**
- If no admissible path exists, terminate with **STOP + GAP**.

This template must be instantiated into a dated run directory under:
`2.runs/YYYY-MM-DD/run_XX_gap_uncertainty_cannot_be_represented_admissibly/`
