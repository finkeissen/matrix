# Gap Candidate Run Template: Competing interpretations irreducible

This is a **run template** (not an executed run).

Purpose:
- Attempt to construct an admissible path for: **Competing interpretations irreducible**
- If no admissible path exists, terminate with **STOP + GAP**.

This template must be instantiated into a dated run directory under:
`2.runs/YYYY-MM-DD/run_XX_gap_competing_interpretations_irreducible/`
