# Gap Candidate Run Template: Accountability cannot be assigned

This is a **run template** (not an executed run).

Purpose:
- Attempt to construct an admissible path for: **Accountability cannot be assigned**
- If no admissible path exists, terminate with **STOP + GAP**.

This template must be instantiated into a dated run directory under:
`2.runs/YYYY-MM-DD/run_XX_gap_accountability_cannot_be_assigned/`
