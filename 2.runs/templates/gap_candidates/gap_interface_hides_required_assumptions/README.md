# Gap Candidate Run Template: Interface hides required assumptions

This is a **run template** (not an executed run).

Purpose:
- Attempt to construct an admissible path for: **Interface hides required assumptions**
- If no admissible path exists, terminate with **STOP + GAP**.

This template must be instantiated into a dated run directory under:
`2.runs/YYYY-MM-DD/run_XX_gap_interface_hides_required_assumptions/`
