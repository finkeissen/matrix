# Gap Candidate Run Template: Measurement collapses scope

This is a **run template** (not an executed run).

Purpose:
- Attempt to construct an admissible path for: **Measurement collapses scope**
- If no admissible path exists, terminate with **STOP + GAP**.

This template must be instantiated into a dated run directory under:
`2.runs/YYYY-MM-DD/run_XX_gap_measurement_collapses_scope/`
