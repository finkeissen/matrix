# Gap Candidate Run Template: Decision requires epistemic upgrade

This is a **run template** (not an executed run).

Purpose:
- Attempt to construct an admissible path for: **Decision requires epistemic upgrade**
- If no admissible path exists, terminate with **STOP + GAP**.

This template must be instantiated into a dated run directory under:
`2.runs/YYYY-MM-DD/run_XX_gap_decision_requires_epistemic_upgrade/`
