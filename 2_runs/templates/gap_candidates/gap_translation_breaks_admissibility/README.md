# Gap Candidate Run Template: Translation breaks admissibility

This is a **run template** (not an executed run).

Purpose:
- Attempt to construct an admissible path for: **Translation breaks admissibility**
- If no admissible path exists, terminate with **STOP + GAP**.

This template must be instantiated into a dated run directory under:
`2.runs/YYYY-MM-DD/run_XX_gap_translation_breaks_admissibility/`
