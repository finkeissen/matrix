# Gap Candidate Run Template: Responsibility diffuses below admissible threshold

This is a **run template** (not an executed run).

Purpose:
- Attempt to construct an admissible path for: **Responsibility diffuses below admissible threshold**
- If no admissible path exists, terminate with **STOP + GAP**.

This template must be instantiated into a dated run directory under:
`2.runs/YYYY-MM-DD/run_XX_gap_responsibility_diffuses_below_admissible_threshold/`
